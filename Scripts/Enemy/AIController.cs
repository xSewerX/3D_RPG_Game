...
public class AIController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isMoving == true)
        {
            anim.SetFloat("Speed", speedWalk, 0.1f, Time.deltaTime);
        }
        else
        {
    ...
    private void Chasing()
    {
        ...
        if (!m_CaughtPlayer)
        {
            CharacterStats.instance.PlayerInCombat(true);
            Move(speedWalk);
   ...
   public void Attack()
    ...
    public void AttackRange()
    {
        ...
        Rigidbody rb = Instantiate(Arrow, weapon.transform.position, transform.rotation).GetComponent<Rigidbody>();
